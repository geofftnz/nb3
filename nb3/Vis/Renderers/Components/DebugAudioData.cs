...
namespace nb3.Vis.Renderers.Components
{
    ...
    /// 
    /// </summary>
    public class DebugAudioData : GameComponentBase, IRenderable, IUpdateable, IReloadable, ITransformable
    {
        ...
        // VBOs for quad
        protected VBO vertexVBO = new VBO("DebugAudioData_q_v");
        protected VBO indexVBO = new VBO("DebugAudioData_q_i",BufferTarget.ElementArrayBuffer);
        protected ShaderProgram program = new ShaderProgram("DebugAudioData_sp");

        public DebugAudioData()
        {
        ...
        private ShaderProgram LoadShader()
        {
            ...
            program.Init(
                @"DebugAudioData.glsl|vert",
                @"DebugAudioData.glsl|frag",
                new List<Variable>
                {
