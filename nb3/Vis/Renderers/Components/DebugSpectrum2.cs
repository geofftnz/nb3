...
namespace nb3.Vis.Renderers.Components
{
    ...
    /// 
    /// </summary>
    public class DebugSpectrum2 : GameComponentBase, IRenderable, IUpdateable, IReloadable, ITransformable
    {
        ...
        // VBOs for quad
        protected VBO vertexVBO = new VBO("DebugSpectrum2_q_v");
        protected VBO indexVBO = new VBO("DebugSpectrum2_q_i", BufferTarget.ElementArrayBuffer);
        protected ShaderProgram program = new ShaderProgram("DebugSpectrum2_sp");

        public DebugSpectrum2()
        {
            Loading += DebugSpectrum2_Loading;
        }

        private void DebugSpectrum2_Loading(object sender, EventArgs e)
        {
            InitVBOsq();
            Reload();
        }
        ...
        private ShaderProgram LoadShader()
        {
            ...
            program.Init(
                ...
                @"DebugSpectrum.glsl|waterfall2_frag",
                new List<Variable>
                {
